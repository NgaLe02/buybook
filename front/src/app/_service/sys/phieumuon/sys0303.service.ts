...
export class Sys0303Service {
  ...
  getDetailPhieuMuon(idPhieuMuon: number) {
    ...
    const url =
      ...
      `/admin/sys0303/phieumuon/chi-tiet?id=` +
      idPhieuMuon;
  ...
  getFine(idPhieuMuon: number, listIdSachTra: string[]) {
    ...
    const url =
      environment.backApiUrl +
      `/admin/sys0303/phieumuon/tien-phat?id=` +
      idPhieuMuon;
    return this.http.post<DataResponse>(url, listIdSachTra, {
      headers: headers,
    });
  }
  ...
  changeStatusToReturnBook(idPhieuMuon: number, listIdSachMat: String[]) {
    ...
    const url =
      environment.backApiUrl +
      `/admin/sys0303/phieumuon/tra-sach?id=` +
      idPhieuMuon;
    return this.http.put<DataResponse>(url, listIdSachMat, {
      headers: headers,
    });
  }
}
