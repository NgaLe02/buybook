...
export class MyUploadAdapter {
  ...
  _initRequest() {
    ...
    let api = environment.backApiUrl + `/admin/sys0201/addImage`
  ...
  _sendRequest(file) {
    ...
    //     this.result = response; // Gán kết quả vào biến result
    //     console.log("result", response); // Giá trị string trả về từ server
    //     // resolve(response); // Trả về kết quả phản hồi
    //   }
    // });
